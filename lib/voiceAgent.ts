...
const PORTFOLIO_AGENT_PROMPT = [
  ...
  '',
  '--- OPEN SOURCE ---',
  'I contribute to open source: forty merged pull requests across openai-agents-python, Stanford DSPy, and pydantic-ai. The vast majority are in openai-agents-python.',
