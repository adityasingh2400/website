      ...
      <div className="mx-auto w-full max-w-[760px]">
        ...
        >
          <p>
            ...
            Isla Vista. I build AI systems&nbsp;— voice interfaces, agents, and automation tools&nbsp;—
            the kind of thing that&apos;s a little weird but that I actually want to use every day.
          </p>
          <p>
            I got here through robotics. I co-founded a robotics nonprofit back home in Fremont, then
            ...
            MIT. Somewhere along the way I fell for the messier, more open-ended side of the
            work: getting machines to understand language, take real actions, and be trusted with
            them.
          </p>
          <p>
            ...
            whole field is being built on&nbsp;— OpenAI&apos;s Agents SDK, Stanford&apos;s DSPy, and
            Pydantic AI.
          </p>
          <p>
            When I&apos;m not building, I&apos;m <a className="story-link" href="#life">hooping</a>,
            pulling all-nighters vibecoding, or arguing about world politics. I just like learning
            things. If you&apos;re working on something ambitious,{' '}
        ...
        >
          ...
          <span className="text-[0.85rem] text-[var(--muted)]">
            or read on&nbsp;— it&apos;s all right here.
          </span>
        </motion.div>
      </div>
    </section>
